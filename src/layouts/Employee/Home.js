...
import Header from '~/components/HeaderEmployee/HeaderEmployee';
import Navigation from '~/components/NavEmployee/Navigation';
            ...
            <div className={cx('container__page-content')}>
                ...
                <div className={cx('introduction')}>
                    <div className={cx('img-employee')}>
                        <img src="https://th.bing.com/th/id/OIP.f18gpVOxty_hnxA0SzFuyAHaNK?pid=ImgDet&rs=1" alt="" />
                    </div>
                    <div className={cx('infor')}>
                        <span className={cx('fullName')}>Xin Chào, Bad Liar</span>
