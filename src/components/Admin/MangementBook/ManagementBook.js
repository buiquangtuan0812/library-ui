...
function ManagementBook() {
    ...
    const handleSearch = () => {
        axios
            .get('https://library-be-wine.vercel.app/library/books/search', { params: { name: nameBook } })
            .then((response) => {
    ...
    const handleFilter = (e) => {
        if (e === '') {
            ...
            axios
                .get('https://library-be-wine.vercel.app/library/books/get-by-type', { params: { type: e } })
                .then((response) => {
                    setdataBook(response.data);
                })
                .catch((err) => console.error(err));
